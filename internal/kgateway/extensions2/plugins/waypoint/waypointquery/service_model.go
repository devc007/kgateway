...
func (svc *Service) CidrRanges() ([]*corev3.CidrRange, error) {
...
func ipsToCidrRanges(ips []string) []*corev3.CidrRange {
	var clusterIPs []*corev3.CidrRange
	for _, addr := range ips {
		...
		clusterIPs = append(clusterIPs, &corev3.CidrRange{
