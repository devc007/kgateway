...
func findTransportSocketMatchByPrefix(matches []*clusterv3.Cluster_TransportSocketMatch, prefix string) *clusterv3.Cluster_TransportSocketMatch {
...
func findTransportSocketMatchByName(matches []*clusterv3.Cluster_TransportSocketMatch, name string) *clusterv3.Cluster_TransportSocketMatch {
	for _, match := range matches {
		if match.Name == name {
			return match
		}
