...
var (
	...
	EnableFilterPerRoute = &envoy_config_route_v3.FilterConfig{Config: &anypb.Any{}}
)
...
func (p *trafficPolicyPluginGwPass) ApplyRouteConfigPlugin(ctx context.Context, pCtx *ir.RouteConfigContext, out *envoy_config_route_v3.RouteConfiguration) {
