...
import (
	...
	envoyroutev3v3 "github.com/envoyproxy/go-control-plane/envoy/config/route/v3"
...
func (p *directResponsePluginGwPass) ApplyForRoute(ctx context.Context, pCtx *ir.RouteContext, outputRoute *envoyroutev3v3.Route) error {
	...
	if outputRoute.GetAction() != nil {
		...
		outputRoute.Action = &envoyroutev3v3.Route_DirectResponse{
			DirectResponse: &envoyroutev3v3.DirectResponseAction{
